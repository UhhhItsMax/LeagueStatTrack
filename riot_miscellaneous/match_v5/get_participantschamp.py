...
def get_participantschamp_function(matchId):
    ...
    if resp.status_code == 200:
        ...
        if game_data:
            ...
            for i in range(num_participants):
                summoner_name = game_data['info']['participants'][i]['championName']
                partiInfo = summoner_name
                parti_champ.append(partiInfo)
    else:
        # API request failed
        parti_champ.append("API request failed")
