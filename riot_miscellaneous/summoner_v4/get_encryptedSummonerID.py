...
def get_encryptedSummonerID_function(summoner_name):
    ...
    if resp.status_code == 200:
        ...
        if player_info:
            player_encryptedSummonerID = player_info['id']
    else:
        #API request failed
        player_encryptedSummonerID = "API request failed"

    return player_encryptedSummonerID
